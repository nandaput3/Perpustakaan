...
<head>
    ...
    table {
        ...
        margin: 0 auto;
        /* Atur margin auto agar tabel berada di tengah halaman */
        margin-bottom: 20px;
    }
                        ...
                        <div class="table-container">
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    $sql_riwayat = "SELECT buku.judul, buku.cover, peminjaman.tgl_pinjam, peminjaman.tgl_kembali, peminjaman.status_pinjam
                                    FROM peminjaman
                                    ...
                                    while ($row_riwayat = mysqli_fetch_assoc($result_riwayat)) {
                                        echo "<tr>";
                                        echo "<td>" . $no++ . "</td>";
                                        echo "<td><img src='" . $row_riwayat['cover'] . "' alt='Cover' style='height: 100px;'></td>";
